...
pub(in super::super) fn gen_consts() -> String {
    ...
    render_f64_const("HALF_LN_2_PI_HI", hi, &mut out);
    render_f64_const("HALF_LN_2_PI_LO", lo, &mut out);
...
pub(in super::super) fn gen_lgamma_poly_1() -> String {
    ...
    let poly_deg = 26;
    let o = 1.0;
    let range = (0.5 - o, 1.101 - o);

    julia::run_and_render_remez_f64(f, range, poly_deg, 0, "K", &[0], &mut out);
...
pub(in super::super) fn gen_special_poly() -> String {
    ...
    julia::run_and_render_remez_f64(f, range, poly_deg, 0, "K", &[], &mut out);
