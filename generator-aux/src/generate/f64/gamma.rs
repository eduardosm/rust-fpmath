...
pub(crate) fn gen_consts() {
    ...
    print_f64_const("HALF_LN_2_PI_HI", hi);
    print_f64_const("HALF_LN_2_PI_LO", lo);
}
...
pub(crate) fn gen_lgamma_poly_1() {
    ...
    julia::run_and_print_remez_f64(f, range, poly_deg, 0, "K", &[0]);
}
...
pub(crate) fn gen_special_poly() {
    ...
    julia::run_and_print_remez_f64(f, range, poly_deg, 0, "K", &[]);
}
