...
const DEG_TO_RAD_HI: f64 = f64::from_bits(0x3F91DF46A0000000); // 1.745329238474369e-2
const DEG_TO_RAD_LO: f64 = f64::from_bits(0x3DE294E9C8AE0EC6); // 1.3519960527851425e-10
