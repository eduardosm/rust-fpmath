use crate::data::{consume_data, f32 as f32_data, f32::mkfloat};
...
fn test_atan() {
    ...
    consume_data("f32_atan", |f32_data::OneArgData { x, expected }| {
...
fn test_atand() {
    let mut max_error: f32 = 0.0;
    consume_data("f32_atand", |f32_data::OneArgData { x, expected }| {
...
fn test_atanpi() {
    let mut max_error: f32 = 0.0;
    consume_data("f32_atanpi", |f32_data::OneArgData { x, expected }| {
...
fn test_atan2() {
    let mut max_error: f32 = 0.0;
    consume_data("f32_atan2", |f32_data::TwoArgData { x, y, expected }| {
...
fn test_atan2d() {
    let mut max_error: f32 = 0.0;
    consume_data("f32_atan2d", |f32_data::TwoArgData { x, y, expected }| {
...
fn test_atan2pi() {
    let mut max_error: f32 = 0.0;
    consume_data("f32_atan2pi", |f32_data::TwoArgData { x, y, expected }| {
...
fn test_asinh() {
    let mut max_error: f32 = 0.0;
    consume_data("f32_asinh", |f32_data::OneArgData { x, expected }| {
...
fn test_acosh() {
    let mut max_error: f32 = 0.0;
    consume_data("f32_acosh", |f32_data::OneArgData { x, expected }| {
...
fn test_atanh() {
    let mut max_error: f32 = 0.0;
    consume_data("f32_atanh", |f32_data::OneArgData { x, expected }| {
...
fn test_cbrt() {
    let mut max_error: f32 = 0.0;
    consume_data("f32_cbrt", |f32_data::OneArgData { x, expected }| {
...
fn test_exp2() {
    let mut max_error: f32 = 0.0;
    consume_data("f32_exp2", |f32_data::OneArgData { x, expected }| {
...
fn test_exp10() {
    let mut max_error: f32 = 0.0;
    consume_data("f32_exp10", |f32_data::OneArgData { x, expected }| {
...
fn test_hypot() {
    let mut max_error: f32 = 0.0;
    consume_data("f32_hypot", |f32_data::TwoArgData { x, y, expected }| {
...
fn test_log() {
    let mut max_error: f32 = 0.0;
    consume_data("f32_log", |f32_data::OneArgData { x, expected }| {
...
fn test_log_1p() {
    let mut max_error: f32 = 0.0;
    consume_data("f32_log_1p", |f32_data::OneArgData { x, expected }| {
...
fn test_log2() {
    let mut max_error: f32 = 0.0;
    consume_data("f32_log2", |f32_data::OneArgData { x, expected }| {
...
fn test_log10() {
    let mut max_error: f32 = 0.0;
    consume_data("f32_log10", |f32_data::OneArgData { x, expected }| {
...
fn test_pow() {
    let mut max_error: f32 = 0.0;
    consume_data("f32_pow", |f32_data::TwoArgData { x, y, expected }| {
...
fn test_powi() {
    let mut max_error: f32 = 0.0;
    consume_data("f32_powi", |f32_data::powi::Data { x, y, expected }| {
...
fn test_tan() {
    let mut max_error: f32 = 0.0;
    consume_data("f32_tan", |f32_data::OneArgData { x, expected }| {
...
fn test_tand() {
    let mut max_error: f32 = 0.0;
    consume_data("f32_tand", |f32_data::OneArgData { x, expected }| {
...
fn test_tanpi() {
    let mut max_error: f32 = 0.0;
    consume_data("f32_tanpi", |f32_data::OneArgData { x, expected }| {
...
fn test_tanh() {
    let mut max_error: f32 = 0.0;
    consume_data("f32_tanh", |f32_data::OneArgData { x, expected }| {
...
fn test_sqrt() {
    let mut max_error: f32 = 0.0;
    consume_data("f32_sqrt", |f32_data::OneArgData { x, expected }| {
...
pub(super) fn test_round_with(test_f: fn(f32)) {
    use rand::Rng as _;
